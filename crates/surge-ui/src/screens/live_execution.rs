...
impl LiveExecutionScreen {
    pub fn new(_cx: &mut Context<Self>) -> Self {
        Self {
            ...
            logs: vec![
                LogEntry {
                    timestamp: "10:42:01".into(),
                    message: "Started: Create JWT module".into(),
                    node_id: Some("n1".into()),
                },
                LogEntry {
                    timestamp: "10:42:15".into(),
                    message: "Writing src/auth/jwt.rs".into(),
                    node_id: Some("n1".into()),
                },
                LogEntry {
                    timestamp: "10:42:30".into(),
                    message: "Completed: Create JWT module (29s)".into(),
                    node_id: Some("n1".into()),
                },
                LogEntry {
                    timestamp: "10:42:31".into(),
                    message: "Started: Add middleware".into(),
                    node_id: Some("n2".into()),
                },
                LogEntry {
                    timestamp: "10:43:00".into(),
                    message: "Completed: Add middleware (29s)".into(),
                    node_id: Some("n2".into()),
                },
                LogEntry {
                    timestamp: "10:43:01".into(),
                    message: "Started: Role-based guards".into(),
                    node_id: Some("n3".into()),
                },
                LogEntry {
                    timestamp: "10:43:10".into(),
                    message: "Writing src/auth/guards.rs".into(),
                    node_id: Some("n3".into()),
                },
            ],
            completed: 2,
                    ...
                    .map(|node| {
                        div()
                            ...
                            .child(
                                div()
                                    .text_xs()
                                    .text_color(node.state.color())
                                    .child(node.state.label().to_string()),
                            )
                    })
                    .collect();
